...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/14 14:59:55 by aemilien          #+#    #+#             */
/*   Updated: 2019/12/14 14:59:56 by aemilien         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					ui_new_message(
		t_ui_panel *ui, const char *str, int type);
void					ui_set_channel_name(
...
int						ui_handle_i18n_direction(
		GtkWidget *label, GtkWidget *hour, const char *msg);
