...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/14 15:11:20 by aemilien          #+#    #+#             */
/*   Updated: 2019/12/14 15:11:22 by aemilien         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			cbuffer_put(
		t_cbuffer *cbuf, const uint8_t *data, size_t n);

int				cbuffer_putstr(
		t_cbuffer *cbuf, const char *str);
...
int				circular_buf_put_safe(
		t_cbuffer *cbuf, const uint8_t data);
...
int				cbuffer_send(
		int cs, t_cbuffer *cbuf, size_t n, int flags);
int				cbuffer_send_until_str(
		int cs, t_cbuffer *cbuf, const char *str, int flags);
