...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/08 17:35:23 by aemilien          #+#    #+#             */
/*   Updated: 2019/12/08 17:35:24 by aemilien         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			irc_privmsg_nomatch_nick(
		t_env *e, int cs, t_token *subtokens, size_t subtoken_count);

int				ping(t_env *e, int cs);
void			broadcast(
		t_env *e, const char *msg, int type, size_t cs);
void			broadcast_all(
		t_env *e, const char *msg, int msg_type, size_t cs);
