...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/14 12:40:25 by aemilien          #+#    #+#             */
/*   Updated: 2019/12/14 12:40:27 by aemilien         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	c2s_whois_check_command(
...
int			c2s_whois(t_env *e, t_token *tokens)
{
	...
	if (c2s_whois_check_command(e, tokens) < 0)
		return (-1);
	if (do_c2s_whois(e->self, tokens[1].addr, tokens[1].len) < 0)
		return (-1);
