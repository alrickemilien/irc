...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/14 12:29:36 by aemilien          #+#    #+#             */
/*   Updated: 2019/12/14 12:29:37 by aemilien         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			ui_clear_panel_window(
		t_env *e, t_ui_panel *ui)
{
	(void)e;
...
int			ui_init_panel(t_env *e, t_ui_panel *ui)
{
	...
	if (gtk_builder_load(ui->builder,
		e->argv_0, "/ui/panel/panel.glade") < 0)
		return (-1);
